...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/DYCoordinateInChina/DYCoordinateInChina.framework"
  install_framework "$BUILT_PRODUCTS_DIR/DYLocationConverter/DYLocationConverter.framework"
